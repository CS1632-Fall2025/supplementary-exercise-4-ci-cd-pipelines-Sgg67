...
public class RentACatUnitTest {
	...
	public void testRenameFailureNumCats0() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		assertNotEquals("Garfield", c2Name);
		Mockito.verify(c2, never()).renameCat(Mockito.anyString());
		out.reset();
		Method m = r.getClass().getDeclaredMethod("getCat", int.class);
		m.setAccessible(true);
		Object ret = m.invoke(r,2);
	 ...
	 */
	@Test
	public void testRentCatNumCats3() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		out.reset();
		r.addCat(c1);
		r.addCat(c2);
		r.addCat(c3);
	...
	public void testRentCatFailureNumCats3() {
		...
		boolean rentCat = r.rentCat(2);
		assertEquals(false, rentCat);
